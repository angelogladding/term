...
from .cli import Application as application
...
builtins.print = print  # NOTE overriding print() -- BUYER BEWARE!


def get_output_width():
    """
    returns the best of env var `TTY_WIDTH`, current terminal width or 80
